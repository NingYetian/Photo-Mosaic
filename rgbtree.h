...
public:
  ...
  /* nearest neighbor function.                                     */
    ...
    */
    ...
    //helper
    void rgbtreeHelper(int lo, int hi, int d);
    RGBAPixel findNearestNeighborHelper(RGBAPixel query, int start, int end, int d) const;
    int distance(RGBAPixel r1, RGBAPixel r2) const; 
};
#endif
